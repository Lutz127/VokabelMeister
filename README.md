...
- Added subcategory navigation pages: Basics, Grammar Basics, Verbs, Adjectives, etc.

- Added automatic Failed Words card disabling

- Added /api/failed_words_count endpoint

- Added improved answer normalization (parentheses ignored, question marks optional)

- Implemented custom 404 Not Found page
